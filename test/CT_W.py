...
class TestRunner:
    ...
    def _save_screenshot(self, save_path: str, step_value: float, test_group: int) -> Optional[str]:
        ...
        try:
            ...
            if test_group == 1:
                filename = f"test1_Temp_{step_value:.2f}C.bmp"
            else:
                filename = f"test2_Curr_{step_value:.2f}mA.bmp"
    ...
    def _save_all_curves(self, save_path: str, step_value: float, test_group: int) -> Optional[str]:
        ...
        try:
            ...
            #timestamp = time.strftime("%Y%m%d_%H%M%S")
            if test_group == 1:
                curve_filename = f"test1_Temp_{step_value:.2f}C"
            else:
                curve_filename = f"test2_Curr_{step_value:.2f}mA"
